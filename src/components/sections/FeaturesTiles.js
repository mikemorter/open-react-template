...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: "Technologies",
    paragraph: "Technologies used in various projects and apps.",
  };
          ...
          <div className={tilesClasses}>
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">React.JS</h4>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Node.JS</h4>
                  <p className="m-0 text-sm"></p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">HTML5</h4>
                  <p className="m-0 text-sm"></p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="mb-16">
                    <Image
                      src={require("./../../assets/images/CSS3_logo.svg.png")}
                      alt="CSS 3 logo"
                      width={64}
                      height={64}
                    />
